...
<template>
    <GuestLayout class="bg-light-primary">
        <Head title="Log in" />
        ...
        <form @submit.prevent="submit">
            <div>
                <InputLabel for="email" value="Email" class="font-semibold text-gary-800"/>
            ...
            <div class="mt-4">
                <InputLabel for="password" value="Password" class="font-semibold text-gary-800"/>
